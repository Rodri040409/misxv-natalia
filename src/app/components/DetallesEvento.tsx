...
export default function DetallesEvento() {
  ...
  return (
    // ✅ overflow-x-hidden evita el scroll horizontal por animaciones (x)
        ...
        <div className="mt-10 sm:mt-12 lg:mt-14 space-y-14 sm:space-y-16 lg:space-y-20">
          ...
          >
            ...
            <div className="text-center md:text-left">
              <motion.p
                variants={titleV}
                className={['text-[2.4rem] sm:text-[3rem] lg:text-[3.8rem]', gold, shadowGold, "font-['PlayFair_Italica']"].join(' ')}
              >
                Vestimenta formal
              </motion.p>
              ...
              <motion.p
                variants={fromRight}
                className={['mt-3 text-[1.55rem] sm:text-[1.85rem] lg:text-[2.2rem]', 'text-white/95', shadowWhite, "font-['Lora']"].join(' ')}
              >
          ...
          >
            <div className="text-center md:text-left md:order-1 order-2">
              <motion.p
                variants={titleV}
                className={['text-[2.1rem] sm:text-[2.5rem] lg:text-[3.1rem]', gold, shadowGold, "font-['Hello']"].join(' ')}
              >
